const Footer = () => {
  return (
    <section className="h-full pt-20 pb-12 lg:px-24 md:px-16 sm:px-8 px-4 bg-[#141432] transition-all duration-500 linear">
      <footer className="footer-2-3">
        ...
        <div className="border-color mx-auto">
          ...
          <div className="container mx-auto flex  pt-12 flex-col lg:flex-row items-center space-y-5 lg:space-y-0">
            <div className="flex title-font cursor-pointer font-medium items-center text-gray-900 mb-4 lg:mb-0 md:mb-0 space-x-5">
              <svg
